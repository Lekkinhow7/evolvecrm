// OpenAPI 3.1.2 "source of truth" for Evolve CRM Public API (Integrations).
//
// NOTE:
...
export function getPublicApiOpenApiDocument(): OpenApiDocument {
  return {
    openapi: '3.1.2',
    info: {
      title: 'Evolve CRM Public API',
      version: 'v1',
      description:
        'API pública do Evolve CRM para integrações (n8n/Make). Produto em primeiro lugar: copiar → colar → testar.',
    },
